...
<body>
	...
	<div class="page-wraper">
        ...
        <footer class="site-footer footer-large footer-dark text-white footer-style1" >
            ...
            <div class="footer-top bg-no-repeat bg-bottom-right" style="background-image:url(/frontend/images/background/footer-bg.png)">
                <div class="container">
                    <div class="row">
       ...
       {{-- <div class="contact-slide-hide bg-cover bg-no-repeat" style="background-image:url(/frontend/images/background/bg-7.jpg)"> 
            <div class="contact-nav">
                 ...
                 <div class="contact-nav-form">
                    <div class="contact-nav-info bg-white p-a30 bg-center bg-no-repeat" style="background-image:url(/frontend/images/background/bg-map2.png);">
                    	<div class="row">
...
<script  src="/frontend/js/rev-script-4.js"></script>
...
<!-- <div class="styleswitcher">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="@theme=css%252Fskin%252Fskin-1"></a></li>
            <li><a class="theme-skin skin-2" href="@theme=css%252Fskin%252Fskin-2"></a></li>
            <li><a class="theme-skin skin-3" href="@theme=css%252Fskin%252Fskin-3"></a></li>
            <li><a class="theme-skin skin-4" href="@theme=css%252Fskin%252Fskin-4"></a></li>
            <li><a class="theme-skin skin-5" href="@theme=css%252Fskin%252Fskin-5"></a></li>
            <li><a class="theme-skin skin-6" href="@theme=css%252Fskin%252Fskin-6"></a></li>
            <li><a class="theme-skin skin-7" href="@theme=css%252Fskin%252Fskin-7"></a></li>
            <li><a class="theme-skin skin-8" href="@theme=css%252Fskin%252Fskin-8"></a></li>
            <li><a class="theme-skin skin-9" href="@theme=css%252Fskin%252Fskin-9"></a></li>
            <li><a class="theme-skin skin-10" href="@theme=css%252Fskin%252Fskin-10"></a></li>
            <li><a class="theme-skin skin-11" href="@theme=css%252Fskin%252Fskin-11"></a></li>
            <li><a class="theme-skin skin-12" href="@theme=css%252Fskin%252Fskin-12"></a></li>
        </ul>           
