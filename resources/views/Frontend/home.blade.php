...
@section('title') Future Smart Heavy Equipment Trading LLC @endsection
@section('content')
  ...
  <div class="wt-icon-card bg-white shadow">
    ...
    <div class="wt-card-content">
      <p>Supporting global buyers and sellers with reliable heavy equipment trading services.</p>
            ...
            <div class="section-full p-t80 p-b40  overlay-wraper bg-cover bg-no-repeat bg-parallax" data-stellar-background-ratio="0.5" style="background-image:url(/frontend/images/background/bg-11.jpg);">
            ...
            <div class="section-full  p-t80 p-b50 bg-white  bg-bottom-right bg-no-repeat" style="background-image:url(/frontend/images/background/bg-5.png)">
                <div class="container">
